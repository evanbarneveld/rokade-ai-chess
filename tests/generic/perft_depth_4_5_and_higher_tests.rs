...
//#[test]
fn _perft_position2_depth4() { //last tested at 13-jan-2026
...
//#[test]
fn _perft_position2_depth5() { //last tested at 13-jan-2026 (412 seconds)
...
//#[test]
fn _perft_position2_depth5_parallel() { //last tested at 6-jan-2026 (54 seconds parallel)
    let time_start = std::time::Instant::now();
    let fen = "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1";
    let gs = reset_from_fen(fen).expect("valid FEN");
...
//#[test]
fn _perft_position4_depth4() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
...
//#[test]
fn _perft_position4_depth5() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
    let fen = "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1";
    let gs = reset_from_fen(fen).expect("valid FEN");
    let nodes:i64 = perft_count(&gs, 5) as i64;
...
//#[test]
fn _perft_position5_depth4() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
...
//#[test]
fn _perft_position6_depth4() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
...
//#[test]
fn _perft_startpos_depths_5() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
    let fen = Chess::DEFAULT_CHESS_STARTING_FEN;
    let gs = reset_from_fen(fen).expect("valid startpos FEN");
...
//#[test]
fn _perft_startpos_depth_6() { // last tested at 6-jan-2026
    let time_start = std::time::Instant::now();
    let fen = Chess::DEFAULT_CHESS_STARTING_FEN;
    let gs = reset_from_fen(fen).expect("valid startpos FEN");
