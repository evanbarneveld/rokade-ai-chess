...
impl TranspositionTable {
    ...
    pub fn new_with_default_size() -> Self { Self::with_capacity_pow2(21) }
    ...
    pub fn store(&mut self, key: u64, depth: i16, bound: Bound, score: i32, best_from: Option<u8>, best_to: Option<u8>) {
        if !crate::search::advanced_search::TRANSPOSITION_TABLE_ENABLED { return; }
        let idx = self.index(key);
    ...
    pub fn hashfull_permille(&self) -> u16 {
        if !crate::search::advanced_search::TRANSPOSITION_TABLE_ENABLED { return 0; }
