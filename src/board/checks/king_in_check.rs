...
pub fn is_king_in_check(board: &mut Board, move_from:(usize, usize), move_to:(usize, usize)) -> bool {
    ...
    is_square_attacked_by_opponent(board, board.get_king_location(piece_color), piece_color);
