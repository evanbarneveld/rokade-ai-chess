        ...
        for c in 0..8 {
            if let Some(p) = board.get(r, c) {
                ...
                match p.get_type() {
                    ...
                    PieceType::Knight => {
                        if is_valid_knight_move(board, (r, c), square) { return true; }
                    }
                    PieceType::Bishop => {
                        if is_valid_bishop_move(board, (r, c), square) { return true; }
                    }
                    PieceType::Rook => {
                        if is_valid_rook_move(board, (r, c), square) { return true; }
                    }
                    PieceType::Queen => {
                        if is_valid_bishop_move(board, (r, c), square) || is_valid_rook_move(board, (r, c), square) { return true; }
                    }
                    PieceType::King => {
