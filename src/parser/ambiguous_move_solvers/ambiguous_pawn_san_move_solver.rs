...
/*
 From an incomplete SAN move and the target location on the board, provide the origin location, or indicate None if the move is not valid.
 */
pub fn solve_ambiguous_pawn_san_move(from_col: i8, from_row: i8, to_col: i8, to_row: i8, is_capture:bool, board: &mut Board, active_color:Color, en_passant_target:Option<(usize,usize)>) -> Option<(u8, u8)> {
